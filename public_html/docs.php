...
<body>
	...
	<div id='frame'>
		<div id='content-box'>
			...
			<p>As funções da gladCode também pode ser usadas no idioma Português. Caso deseje consulta-las, <a href='docs-ptbr.php'>clique aqui</a>.</p>
			...
			<h2 id='nav-setup'>Setup</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=setname'>setName</a></td>
							<td>Atribui um nome para o gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=setstr'>setSTR</a></td>
							<td>Atribui um valor para o atributo Força (STR) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=setagi'>setAGI</a></td>
							<td>Atribui um valor para o atributo Agilidade (AGI) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=setint'>setINT</a></td>
							<td>Atribui um valor para o atributo Inteligência (INT) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=setspritesheet'>setSpritesheet</a></td>
			...
			<h2 id='nav-up'>Melhorias</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=upgradestr'>upgradeSTR</a></td>
							<td>Indica que o gladiador deve aprimorar o atributo Força.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=upgradeagi'>upgradeAGI</a></td>
							<td>Indica que o gladiador deve aprimorar o atributo Agilidade.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=upgradeint'>upgradeINT</a></td>
			...
			<h2 id='nav-mov'>Movimento</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=moveforward'>moveForward</a></td>
							<td>Move o gladiador para frente uma quantidade de passos.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=moveto'>moveTo</a></td>
							<td>Move o gladiador para um ponto.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=movetotarget'>moveToTarget</a></td>
							<td>Move o gladiador para o alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=stepforward'>stepForward</a></td>
							<td>Move o gladiador para frente.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=stepback'>stepBack</a></td>
							<td>Move o gladiador para trás.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=stepleft'>stepLeft</a></td>
							<td>Move o gladiador para esquerda.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=stepright'>stepRight</a></td>
							<td>Move o gladiador para direita.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turnleft'>turnLeft</a></td>
							<td>Rotaciona o gladiador no sentido anti-horário.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turnright'>turnRight</a></td>
							<td>Rotaciona o gladiador no sentido horário.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turn'>turn</a></td>
							<td>Rotaciona o gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turnto'>turnTo</a></td>
							<td>Rotaciona o gladiador para um ponto.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turntotarget'>turnToTarget</a></td>
							<td>Rotaciona o gladiador para o alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turntolasthit'>turnToLastHit</a></td>
							<td>Rotaciona o gladiador para a origem do último ataque recebido.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=turntoangle'>turnToAngle</a></td>
			...
			<h2 id='nav-att'>Ataque</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=attackmelee'>attackMelee</a></td>
							<td>Realiza um ataque corpo-a-corpo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=attackranged'>attackRanged</a></td>
			...
			<h2 id='nav-info'>Informações do gladiador</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=getstr'>getSTR</a></td>
							<td>Retorna o valor do atributo Força (STR) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getagi'>getAGI</a></td>
							<td>Retorna o valor do atributo Agilidade (AGI) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getint'>getINT</a></td>
							<td>Retorna o valor do atributo Inteligência (INT) do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getx'>getX</a></td>
							<td>Retorna a coordenada x do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gety'>getY</a></td>
							<td>Retorna a coordenada y do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gethp'>getHp</a></td>
							<td>Retorna os pontos de vida do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getap'>getAp</a></td>
							<td>Retorna os pontos de habilidade do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getspeed'>getSpeed</a></td>
							<td>Retorna a velocidade do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gethead'>getHead</a></td>
							<td>Retorna a direção do gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gethit'>getHit</a></td>
							<td>Descobre se o gladiador foi atacado.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getlasthittime'>getLastHitTime</a></td>
							<td>Retorna o tempo desde o último ataque recebido.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getlasthitangle'>getLastHitAngle</a></td>
							<td>Retorna o ângulo de onde veio o último ataque.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getblocktimeleft'>getBlockTimeLeft</a></td>
							<td>Retorna o tempo restante para expirar o efeito Proteção.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getambushtimeleft'>getAmbushTimeLeft</a></td>
							<td>Retorna o tempo restante para expirar o efeito Invisibilidade.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=speak'>speak</a></td>
			...
			<h2 id='nav-sense'>Percepção do ambiente</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=issafehere'>isSafeHere</a></td>
							<td>Descobre se o gladiador está dentro da nuvem tóxica.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=issafethere'>isSafeThere</a></td>
							<td>Descobre se o ponto está dentro da nuvem tóxica.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getsaferadius'>getSafeRadius</a></td>
							<td>Retorna o raio da área livre de nuvem tóxica.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=howmanyenemies'>howManyEnemies</a></td>
							<td>Retorna a quantidade de inimigos no campo de visão.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getcloseenemy'>getCloseEnemy</a></td>
							<td>Procura um inimigo próximo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getfarenemy'>getFarEnemy</a></td>
							<td>Procura um inimigo distante.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getlowhp'>getLowHp</a></td>
							<td>Procura um inimigo com menos vida.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gethighhp'>getHighHp</a></td>
							<td>Procura um inimigo com mais vida.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gettargetx'>getTargetX</a></td>
							<td>Retorna o valor da coordenada x do alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gettargety'>getTargetY</a></td>
							<td>Retorna o valor da coordenada y do alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gettargethealth'>getTargetHealth</a></td>
							<td>Retorna a vida do alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gettargetspeed'>getTargetSpeed</a></td>
							<td>Retorna a velocidade do alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=gettargethead'>getTargetHead</a></td>
							<td>Retorna a direção do alvo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=doyouseeme'>doYouSeeMe</a></td>
							<td>Descobre se o alvo enxerga o gladiador.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=istargetvisible'>isTargetVisible</a></td>
							<td>Descobre se alvo está no campo de visão.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=isstunned'>isStunned</a></td>
							<td>Verifica se o alvo está atordoado.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=isburning'>isBurning</a></td>
							<td>Verifica se o alvo está queimando.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=isprotected'>isProtected</a></td>
							<td>Verifica se o alvo está protegido.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=isrunning'>isRunning</a></td>
							<td>Verifica se o alvo está correndo.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=isslowed'>isSlowed</a></td>
			...
			<h2 id='nav-math'>Matemática</h2>
				...
				<table class='table t-funcs'>
					<tbody>
						<tr>
							<td><a href='function.php?f=getdist'>getDist</a></td>
							<td>Retorna a distância até o ponto.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getdisttotarget'>getDistToTarget</a></td>
							<td>Retorna a distância até o alvo fixado.</td>
						</tr>
						<tr>
							<td><a href='function.php?f=getangle'>getAngle</a></td>
