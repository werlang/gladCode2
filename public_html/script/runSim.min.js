...
height:this.obj.height()});this.bsize=this.obj.width()/100*d;this.obj.find("#bar").width(this.bsize.toFixed(0))};progressButton.prototype.isActive=function(){return 0<this.obj.find("#oldcontent").length?!0:!1};function decodeHTML(a){var d={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},b;for(b in d)a=a.replace(new RegExp(d[b],"g"),b);return a};
