...
Blockly.Component.prototype.addChildAt = function(a, b, c) {
    ...
    a.render_(this.getContentElement(), b ? b.element_ : null)) : this.inDocument_ && !a.inDocument_ && a.element_ && a.element_.parentNode && a.element_.parentNode.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE && a.enterDocument()
}
;
...
Blockly.Xml.blockToDom = function(a, b) {
    ...
    for (e = 0; f = a.inputList[e]; e++) {
        ...
        if (f.type != Blockly.DUMMY_INPUT) {
            ...
            k && (h.appendChild(Blockly.Xml.blockToDom(k, b)),
            g = !1);
...
Blockly.Xml.cloneShadow_ = function(a, b) {
    for (var c = a = a.cloneNode(!0), d; c; )
        ...
        c.firstChild)
            ...
            c && (d = c,
            c = c.nextSibling,
            d.nodeType == Blockly.utils.dom.Node.TEXT_NODE && "" == d.data.trim() && Blockly.utils.dom.removeNode(d))
        }
    return a
}
;
...
Blockly.fieldRegistry.register = function(a, b) {
    if ("string" != typeof a || "" == a.trim())
        throw Error('Invalid field type "' + a + '". The type must be a non-empty string.');
...
Blockly.InsertionMarkerManager.prototype.highlightBlock_ = function() {
    ...
    a.targetBlock().highlightForReplacement(!0)) : b.type == Blockly.OUTPUT_VALUE && (this.highlightedBlock_ = a.getSourceBlock(),
    a.getSourceBlock().highlightShapeForInput(a, !0));
...
Blockly.InsertionMarkerManager.prototype.connectMarker_ = function() {
    ...
    if (a == this.markerConnection_)
        throw Error("Made it to connectMarker_ even though the marker isn't changing");
    c.render();
    c.rendered = !0;
...
Blockly.BlockDragger.prototype.startBlockDrag = function(a, b) {
    ...
    if (a = this.workspace_.getToolbox())
        b = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab",
        a.addStyle(b)
}
;
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function() {
    ...
    this.fireMoveEvent_(),
    this.draggingBlock_.dispose(!1, !0)) : a && a.close();
    return this.wouldDeleteBlock_
}
;
...
Blockly.BubbleDragger.prototype.endBubbleDrag = function(a, b) {
    ...
    this.fireMoveEvent_());
    this.workspace_.setResizesEnabled(!0);
    this.workspace_.getToolbox() && (a = this.draggingBubble_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab",
...
Blockly.navigation.focusWorkspace_ = function() {
    ...
    Blockly.navigation.currentState_ = Blockly.navigation.STATE_WS;
    0 < d.length ? b.setCurNode(Blockly.navigation.getTopNode(d[0])) : (c = new Blockly.utils.Coordinate(100,100),
...
Blockly.navigation.onBlocklyAction = function(a) {
    var b = Blockly.getMainWorkspace().options.readOnly
        , c = !1;
    Blockly.getMainWorkspace().keyboardAccessibilityMode ? b ? -1 < Blockly.navigation.READONLY_ACTION_LIST.indexOf(a) && (c = Blockly.navigation.handleActions_(a)) : c = Blockly.navigation.handleActions_(a) : a.name === Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV && (Blockly.navigation.enableKeyboardAccessibility(),
    c = !0);
    return c
}
;
...
Blockly.navigation.flyoutOnAction_ = function(a) {
    var b = Blockly.getMainWorkspace()
        , c = b.getToolbox();
    if ((b = c ? c.flyout_ : b.getFlyout()) && b.onBlocklyAction(a))
        return !0;
    switch (a.name) {
...
Blockly.navigation.toolboxOnAction_ = function(a) {
    var b = Blockly.getMainWorkspace()
        , c = b.getToolbox();
    return c && c.onBlocklyAction(a) ? !0 : a.name === Blockly.navigation.actionNames.TOOLBOX ? (b.getToolbox() ? Blockly.navigation.focusToolbox_() : Blockly.navigation.focusFlyout_(),
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function() {
    return this.targetBlock_ && this.flyout_.isBlockCreatable_(this.targetBlock_) ? !this.flyout_.isScrollable() || this.flyout_.isDragTowardWorkspace(this.currentDragDeltaXY_) ? (this.startWorkspace_ = this.flyout_.targetWorkspace_,
...
Blockly.Gesture.prototype.doStart = function(a) {
    ...
    this.targetBlock_ && (!this.targetBlock_.isInFlyout && a.shiftKey && this.targetBlock_.workspace.keyboardAccessibilityMode ? this.creatorWorkspace_.getCursor().setCurNode(Blockly.navigation.getTopNode(this.targetBlock_)) : this.targetBlock_.select()),
...
Blockly.Field.prototype.updateSize_ = function() {
    ...
    this.borderRect_ && (a += 2 * this.constants_.FIELD_BORDER_RECT_X_PADDING,
    this.borderRect_.setAttribute("width", a));
    this.size_.width = a
}
;
        ...
        if (!(a instanceof Error)) {
            if (b = this.getValidator())
                ...
                a instanceof Error)
                    return;
            b = this.getValue();
            b !== a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_,"field",this.name || null,b,a)),
...
Blockly.Input.prototype.setVisible = function(a) {
    ...
    for (var c = (this.visible_ = a) ? "block" : "none", d = 0, e; e = this.fieldRow[d]; d++)
        e.setVisible(a);
    this.connection && (a ? b = this.connection.startTrackingAll() : this.connection.stopTrackingAll(),
...
Blockly.Menu.prototype.setHighlightedIndex = function(a) {
    ...
    b ? (b.setHighlighted(!0),
    this.highlightedIndex_ = a) : -1 < this.highlightedIndex_ && (this.getHighlighted().setHighlighted(!1),
    this.highlightedIndex_ = -1);
...
Blockly.Menu.prototype.highlightHelper = function(a, b) {
    ...
    for (var d = 0; d <= c; ) {
        ...
        if (e && this.canHighlightItem(e))
            return this.setHighlightedIndex(b),
            !0;
        d++;
        b = a.call(this, b, c)
    }
...
Blockly.Menu.prototype.handleMouseOver_ = function(a) {
    (a = this.getMenuItem(a.target)) && a.isEnabled() && this.getHighlighted() !== a && (this.unhighlightCurrent(),
...
Blockly.Menu.prototype.handleKeyEvent = function(a) {
    return 0 != this.getChildCount() && this.handleKeyEventInternal(a) ? (a.preventDefault(),
    a.stopPropagation(),
    !0) : !1
}
;
...
Blockly.MenuItem.prototype.setChecked = function(a) {
    if (this.checkable_) {
        ...
        b && this.isEnabled() && (a ? (Blockly.utils.dom.addClass(b, "goog-option-selected"),
        Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, !0)) : (Blockly.utils.dom.removeClass(b, "goog-option-selected"),
        Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, !1)))
    }
}
;
...
Blockly.MenuItem.prototype.handleClick = function(a) {
    this.isEnabled() && (this.setHighlighted(!0),
...
Blockly.BlockSvg.prototype.setCollapsed = function(a) {
    if (this.collapsed_ != a) {
        ...
        if (a) {
            ...
            this.warning && (this.warning.setText("", Blockly.BlockSvg.COLLAPSED_WARNING_ID),
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    ...
    if (this.workspace.isDragging()) {
        ...
        b = !1;
        "string" == typeof a ? (this.warning || (this.warning = new Blockly.Warning(this),
        b = !0),
...
Blockly.ThemeManager.prototype.setTheme = function(a) {
    if (this.theme_ !== a) {
        ...
        if (a = this.workspace_.getInjectionDiv())
            b && Blockly.utils.dom.removeClass(a, b.name + "-theme"),
...
Blockly.init_ = function(a) {
    ...
    if (b.languageTree) {
        ...
        var d = a.getFlyout(!0);
        c ? c.init() : d && (d.init(a),
        d.show(b.languageTree.childNodes),
        d.scrollToStart())
    }
...
Blockly.FlyoutButton.prototype.createDom = function() {
    ...
    this.height = 20;
    this.isLabel_ || (this.width += 2 * Blockly.FlyoutButton.MARGIN,
...
Blockly.tree.BaseNode.prototype.addChildAt = function(a, b) {
    ...
    if (b = this.getElement())
        ...
        Blockly.utils.aria.setState(b, Blockly.utils.aria.State.EXPANDED, this.getExpanded()),
        this.getExpanded()) {
...
Blockly.tree.BaseNode.prototype.selectChild = function() {
    return this.hasChildren() ? (this.getExpanded() ? this.getFirstChild().select() : this.setExpanded(!0),
    !0) : !1
}
;
...
Blockly.tree.TreeNode.prototype.onClick_ = function(a) {
    this.hasChildren() && this.isUserCollapsible() ? (this.toggle(),
...
Blockly.tree.TreeControl.prototype.detachEvents_ = function() {
    this.onFocusWrapper_ && (Blockly.unbindEvent_(this.onFocusWrapper_),
    this.onFocusWrapper_ = null);
    this.onBlurWrapper_ && (Blockly.unbindEvent_(this.onBlurWrapper_),
...
Blockly.tree.TreeControl.prototype.handleKeyEvent_ = function(a) {
    ...
    if (b = this.selectedItem_ && this.selectedItem_.onKeyDown(a) || b)
        Blockly.utils.style.scrollIntoContainerView(this.selectedItem_.getElement(), this.getElement().parentNode),
        a.preventDefault();
    return b
}
;
...
Blockly.Toolbox.prototype.handleAfterTreeSelected_ = function(a, b) {
    ...
    a != b && a != this && (a = new Blockly.Events.Ui(null,"category",a && a.getText(),b && b.getText()),
    ...
    for (var d = null, e = null, f = 0, g; g = a.childNodes[f]; f++)
        if (g.tagName)
            ...
            case "CATEGORY":
                ...
                l && k ? (h.hexColour = "",
                console.warn('Toolbox category "' + e + '" can not have both a style and a colour')) : k ? this.setColourFromStyle_(k, h, e) : this.setColour_(l, h, e);
                "true" == g.getAttribute("expanded") ? (h.blocks.length && (d = h),
                h.setExpanded(!0)) : h.setExpanded(!1);
                e = g;
                break;
            case "SEP":
...
Blockly.FieldColour.prototype.doValueUpdate_ = function(a) {
    this.value_ = a;
    this.borderRect_ ? this.borderRect_.style.fill = a : this.sourceBlock_ && (this.sourceBlock_.pathObject.svgPath.setAttribute("fill", a),
...
Blockly.FieldDropdown.prototype.render_ = function() {
    ...
    this.borderRect_ && (this.borderRect_.setAttribute("height", this.size_.height),
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function(a) {
    ...
    this.sourceBlock_.RTL ? (c = d - 1,
    this.imageElement_.setAttribute("x", d + e),
    this.textElement_.setAttribute("x", c)) : (c = c + e + d + 1,
    this.textElement_.setAttribute("text-anchor", "end"),
    this.textElement_.setAttribute("x", c),
    this.imageElement_.setAttribute("x", d));
...
Blockly.FieldMultilineInput.prototype.updateSize_ = function() {
    ...
    this.borderRect_ && (b += 2 * this.constants_.FIELD_BORDER_RECT_X_PADDING,
...
Blockly.blockRendering.ConstantProvider.prototype.refreshTheme = function(a) {
    ...
    a = a.blockStyles;
    for (var b in a)
        this.blockStyles[b] = this.validatedBlockStyle_(a[b])
}
;
...
Blockly.blockRendering.MarkerSvg.prototype.draw = function(a, b) {
    b ? (this.showAtLocation_(b),
    this.firemarkerEvent_(a, b),
    a = this.currentMarkerSvg.childNodes[0],
    void 0 !== a && a.beginElement && a.beginElement()) : this.hide()
}
;
Blockly.blockRendering.MarkerSvg.prototype.showAtLocation_ = function(a) {
    a.getType() == Blockly.ASTNode.types.BLOCK ? (a = a.getLocation(),
    this.showWithBlockPrevOutput_(a)) : a.getType() == Blockly.ASTNode.types.OUTPUT ? (a = a.getLocation().getSourceBlock(),
    this.showWithBlockPrevOutput_(a)) : a.getLocation().type == Blockly.INPUT_VALUE ? this.showWithInput_(a) : a.getLocation().type == Blockly.NEXT_STATEMENT ? this.showWithNext_(a) : a.getType() == Blockly.ASTNode.types.PREVIOUS ? (a = a.getLocation().getSourceBlock(),
    this.showWithBlockPrevOutput_(a)) : a.getType() == Blockly.ASTNode.types.FIELD ? this.showWithField_(a) : a.getType() == Blockly.ASTNode.types.WORKSPACE ? this.showWithCoordinates_(a) : a.getType() == Blockly.ASTNode.types.STACK && this.showWithStack_(a)
}
;
...
Blockly.blockRendering.PathObject.prototype.setMarkerSvg = function(a) {
    a ? (this.cursorSvg_ ? this.svgRoot.insertBefore(a, this.cursorSvg_) : this.svgRoot.appendChild(a),
    this.markerSvg_ = a) : this.markerSvg_ = null
}
;
...
Blockly.geras.Highlighter.prototype.drawJaggedEdge_ = function(a) {
    this.info_.RTL && (this.steps_ += Blockly.utils.svgPaths.lineOnAxis("H", a.width - this.highlightOffset_),
    this.steps_ += this.jaggedTeethPaths_.pathLeft,
    this.steps_ += Blockly.utils.svgPaths.lineOnAxis("v", a.height - this.jaggedTeethPaths_.height - this.highlightOffset_))
}
;
...
Blockly.geras.PathObject.prototype.updateHighlighted = function(a) {
    a ? (this.svgPath.setAttribute("filter", "url(#" + this.constants_.embossFilterId + ")"),
...
Blockly.zelos.RenderInfo.prototype.getSpacerRowHeight_ = function(a, b) {
    ...
    return d || c ? (a = Math.max(this.constants_.MEDIUM_PADDING, Math.max(this.constants_.NOTCH_HEIGHT, this.constants_.INSIDE_CORNERS.rightHeight || 0)),
...
Blockly.zelos.RenderInfo.prototype.addInput_ = function(a, b) {
    ...
    this.isInline && a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.InlineInput(this.constants_,a)),
    b.hasInlineInput = !0) : a.type == Blockly.NEXT_STATEMENT ? (b.elements.push(new Blockly.zelos.StatementInput(this.constants_,a)),
    b.hasStatement = !0) : a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.ExternalValueInput(this.constants_,a)),
    b.hasExternalInput = !0) : a.type == Blockly.DUMMY_INPUT && (b.minHeight = Math.max(b.minHeight, a.getSourceBlock() && a.getSourceBlock().isShadow() ? this.constants_.DUMMY_INPUT_SHADOW_MIN_HEIGHT : this.constants_.DUMMY_INPUT_MIN_HEIGHT),
    b.hasDummyInput = !0);
    null == b.align && (b.align = a.align)
...
Blockly.zelos.RenderInfo.prototype.finalizeHorizontalAlignment_ = function() {
    if (this.outputConnection) {
        ...
        if (a)
            ...
            b = 0; c = this.rows[b]; b++) {
                if (Blockly.blockRendering.Types.isTopRow(c) || Blockly.blockRendering.Types.isBottomRow(c))
...
Blockly.zelos.RenderInfo.prototype.getNegativeSpacing_ = function(a) {
    ...
    return Blockly.blockRendering.Types.isInlineInput(a) ? (a = a.connectedBlock ? a.connectedBlock.pathObject.outputShapeType : a.shape.type,
...
Blockly.zelos.Drawer.prototype.drawOutline_ = function() {
    this.info_.outputConnection && this.info_.outputConnection.isDynamicShape ? (this.drawFlatTop_(),
...
Blockly.zelos.PathObject.prototype.updateSelected = function(a) {
    ...
    this.svgPathSelected_.setAttribute("filter", "url(#" + this.constants_.highlightGlowFilterId + ")"),
    ...
    init: function() {
        ...
        this.setTooltip(function() {
            ...
            if ("FROM_START" == e || "FROM_END" == e)
                d += "  " + ("FROM_START" == e ? Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP : Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", b.workspace.options.oneBasedIndex ? "#1" : "#0");
            return d
        })
    },
    mutationToDom: function() {
...
Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN = {
    ...
    reconnectChildBlocks_: function(a, b, c) {
        for (var e = 1; e <= this.elseifCount_; e++)
            Blockly.Mutator.reconnect(a[e], this, "IF" + e),
...
Blockly.Constants.Logic.LOGIC_TERNARY_ONCHANGE_MIXIN = {
    ...
    onchange: function(a) {
        ...
        if ((b || c) && e)
            for (var d = 0; 2 > d; d++) {
                var f = 1 == d ? b : c;
                f && !f.outputConnection.checkType(e) && (Blockly.Events.setGroup(a.group),
                e === this.prevParentConnection_ ? (this.unplug(),
                e.getSourceBlock().bumpNeighbours()) : (f.unplug(),
                f.bumpNeighbours()),
                Blockly.Events.setGroup(!1))
            }
...
Blockly.Blocks.procedures_defnoreturn = {
    ...
    renameVarById: function(a, b) {
        ...
        if ("" == c.type) {
            ...
            for (var e = !1, d = 0; d < this.argumentVarModels_.length; d++)
                this.argumentVarModels_[d].getId() == a && (this.arguments_[d] = b.name,
                this.argumentVarModels_[d] = b,
                e = !0);
            e && (this.displayRenamedVar_(c, b.name),
            Blockly.Procedures.mutateCallers(this))
        }
    },
    ...
    displayRenamedVar_: function(a, b) {
        ...
        if (this.mutator && this.mutator.isVisible())
            for (var c = this.mutator.workspace_.getAllBlocks(!1), e = 0, d; d = c[e]; e++)
...
Blockly.Blocks.procedures_mutatorarg = {
    ...
    validator_: function(a) {
        ...
        for (var e = (b.workspace.targetWorkspace || b.workspace).getAllBlocks(!1), d = 0; d < e.length; d++)
            if (e[d].id != this.getSourceBlock().id && e[d].getFieldValue("NAME") == a)
                return null;
        if (b.isInFlyout)
            return a;
        ...
        if (b)
            if (a.join("\n") == this.arguments_.join("\n"))
                ...
                for (var d = 0; d < this.arguments_.length; d++) {
                    ...
                    e && f && -1 == b.indexOf(this.quarkIds_[d]) && (f.disconnect(),
                    f.getSourceBlock().bumpNeighbours()))
                }
                this.arguments_ = [].concat(a);
                this.argumentVarModels_ = [];
                for (d = 0; d < this.arguments_.length; d++)
                    a = Blockly.Variables.getOrCreateVariablePackage(this.workspace, null, this.arguments_[d], ""),
                ...
                if (this.quarkIds_ = b)
                    for (d = 0; d < this.arguments_.length; d++)
                        ...
                        Blockly.Mutator.reconnect(f, this, "ARG" + d) || delete this.quarkConnections_[b]);
...
Blockly.JavaScript.controls_if = function(a) {
    ...
    do {
        ...
        c += (0 < b ? " else " : "") + "if (" + d + ") {\n" + e + "}";
        ++b
    } while (a.getInput("IF" + b));if (a.getInput("ELSE") || Blockly.JavaScript.STATEMENT_SUFFIX)
