...
this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var c=a[b];a[b]=null;try{c()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};b.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var e=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var b=this.createResolveAndReject_();try{a(b.resolve,b.reject)}catch(k){b.reject(k)}};e.prototype.createResolveAndReject_=function(){function a(a){return function(f){c||(c=!0,a.call(b,f))}}var b=this,c=!1;
...
$(document).ready(function(){$("#support input").click(function(){$("#support #one-time:checked").length?$("#support #method").slideDown():($("#support #method").fadeOut(),$("#support #method input").removeProp("checked"));$("#support .donate").addClass("hidden");$("#support #buttons").hide();$("#support #crypto:checked").length&&$("#support #bitcoin, #support #ethereum").removeClass("hidden");$("#support #boleto:checked").length+$("#support #card:checked").length&&$("#support #pagseguro").removeClass("hidden");
$("#support #monthly:checked").length+$("#support #card:checked").length&&$("#support #paypal").removeClass("hidden");$("#support #buttons").slideDown("fast")});$("#support .donate.small").click(function(){var a=$(this).attr("id");console.log($("#footer #"+a).length);$("#footer #"+a).click()})});$(document).ready(function(){$(".radio").parents("label").wrap("<div class='radio'></div>");$(".radio label").addClass("option").append("<div class='border'><div class='inner'></div></div>")});function initGoogleLogin(){var a=setInterval(function(){"undefined"!==typeof gapi&&(gapi.load("auth2",function(){auth2=gapi.auth2.init({client_id:"108043684563-uhl9ui9p47r5fadmu31mr3mmg7g4936n.apps.googleusercontent.com",cookiepolicy:"single_host_origin"})}),clearInterval(a))},10)}
