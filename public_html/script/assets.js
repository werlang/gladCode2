...
assets.fill = function(){
    ...
    for (let k=0 ; k<gender.length ; k++){
        for (let j=0 ; j<colors.length ; j++){
            for (let i=0 ; i<styles[k].length ; i++){
                ...
                this.images.push(JSON.parse(new_shirt));
            }	
        }	
    }
    ...
    for (let k=0 ; k<gender.length ; k++){
        for (let j=0 ; j<colors.length ; j++){
            ...
            this.images.push(JSON.parse(new_pants));
        }	
    }
    ...
    for (let k=0 ; k<gender.length ; k++){
        for (let j=0 ; j<weapons.length ; j++){
            ...
            this.images.push(JSON.parse(new_weapon));
        }	
    }
    ...
    for (let k=0 ; k<gender.length ; k++){
        for (let j=0 ; j<names.length ; j++){
            ...
            this.images.push(JSON.parse(new_shield));
        }	
    }
    ...
    for (let i=0 ; i<2 ; i++){
        for (let j=0 ; j<colors.length ; j++){
            ...
            this.images.push(JSON.parse(new_cape[0+i*2]));
            this.images.push(JSON.parse(new_cape[1+i*2]));
        }
    }
