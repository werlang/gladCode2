	...
	$('#panel #tourn.wrapper #create').click( function() {
		...
		$('.tourn-box #public .checkslider').click( function(){
			...
			if ($(this).prop('checked'))
				$('.tourn-box #pass').animate({height:0, opacity: 0}, 1000).val("");
			else
				$('.tourn-box #pass').removeProp('style');
		});
	});
