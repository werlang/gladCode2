...
Blockly.Python.controls_if = function(a) {
    ...
    do {
        ...
        c += (0 == b ? "if " : "elif ") + d + ":\n" + e;
        ++b
    } while (a.getInput("IF" + b));if (a.getInput("ELSE") || Blockly.Python.STATEMENT_SUFFIX)
...
Blockly.Python.controls_for = function(a) {
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e))
        ...
        var l = function(a, c) {
            Blockly.isNumber(a) ? a = Number(a) : a.match(/^\w+$/) ? a = "float(" + a + ")" : (c = Blockly.Python.variableDB_.getDistinctName(b + c, Blockly.VARIABLE_CATEGORY_NAME),
            h += c + " = float(" + a + ")\n",
            a = c);
            return a
        };
